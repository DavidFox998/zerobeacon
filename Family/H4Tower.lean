-- Inlined from the canonical source: eutheos-property/Family/H4Tower.lean.
...
theorem tower_inflation_56_90 :
    (90 : ℝ) / 56 > (8 : ℝ) / 5 ∧ (90 : ℝ) / 56 < (17 : ℝ) / 10 := by
  constructor <;> norm_num

theorem tower_inflation_90_146 :
    (146 : ℝ) / 90 > (8 : ℝ) / 5 ∧ (146 : ℝ) / 90 < (17 : ℝ) / 10 := by
  constructor <;> norm_num
