...
// Module: Beal.B16_BealFinal
// Imports: Init Beal.B16_BealFinal_Core Beal.B15_LevelTo2
#include <lean/lean.h>
...
LEAN_EXPORT lean_object* initialize_Beal_B16__BealFinal(uint8_t builtin, lean_object* w) {
lean_object * res;
