...
// Module: Beal.B07_Galois
// Imports: Init Beal.B07_Galois_Core Beal.B02_Frey Mathlib.Data.Nat.Prime.Basic
#include <lean/lean.h>
...
LEAN_EXPORT lean_object* initialize_Beal_B07__Galois(uint8_t builtin, lean_object* w) {
lean_object * res;
