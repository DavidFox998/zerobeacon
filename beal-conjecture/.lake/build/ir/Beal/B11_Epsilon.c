...
// Module: Beal.B11_Epsilon
// Imports: Init Beal.B11_Epsilon_Core Beal.B10_RibetReal
#include <lean/lean.h>
...
LEAN_EXPORT lean_object* initialize_Beal_B11__Epsilon(uint8_t builtin, lean_object* w) {
lean_object * res;
