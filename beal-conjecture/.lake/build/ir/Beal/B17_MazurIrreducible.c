...
// Module: Beal.B17_MazurIrreducible
// Imports: Init Beal.B17_MazurIrreducible_Core Beal.B16_BealFinal
#include <lean/lean.h>
...
LEAN_EXPORT lean_object* initialize_Beal_B17__MazurIrreducible(uint8_t builtin, lean_object* w) {
lean_object * res;
