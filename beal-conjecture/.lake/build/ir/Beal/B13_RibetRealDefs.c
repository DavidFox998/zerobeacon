...
// Module: Beal.B13_RibetRealDefs
// Imports: Init Beal.B13_RibetRealDefs_Core Beal.B11_Epsilon
#include <lean/lean.h>
...
LEAN_EXPORT lean_object* initialize_Beal_B13__RibetRealDefs(uint8_t builtin, lean_object* w) {
lean_object * res;
