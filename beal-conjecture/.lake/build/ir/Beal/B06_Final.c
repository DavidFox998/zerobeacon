...
// Module: Beal.B06_Final
// Imports: Init Beal.B01_Def Beal.B06_Final_Core Beal.B05_HasseWiles
#include <lean/lean.h>
...
LEAN_EXPORT lean_object* initialize_Beal_B06__Final(uint8_t builtin, lean_object* w) {
lean_object * res;
