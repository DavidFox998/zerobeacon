...
// Module: Beal.B01_Def
// Imports: Init Beal.B01_Def_Core Mathlib.Data.Nat.GCD.Basic Mathlib.Tactic
#include <lean/lean.h>
...
LEAN_EXPORT lean_object* initialize_Beal_B01__Def(uint8_t builtin, lean_object* w) {
lean_object * res;
