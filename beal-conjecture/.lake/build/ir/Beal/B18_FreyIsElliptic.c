...
// Module: Beal.B18_FreyIsElliptic
// Imports: Init Beal.B18_FreyIsElliptic_Core Beal.B17_MazurIrreducible
#include <lean/lean.h>
...
LEAN_EXPORT lean_object* initialize_Beal_B18__FreyIsElliptic(uint8_t builtin, lean_object* w) {
lean_object * res;
