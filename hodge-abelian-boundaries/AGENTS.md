# AGENTS.md — hodge-abelian-boundaries

## Role: HODGE-CLUSTER

**Cluster:** Hodge Conjecture

**Core claim:** Abelian boundary cases — Hodge classes as algebraic cycles
...
expressed in the language of Hodge Conjecture.

## Entry point for AI agents

Look for `Hodge` or `Abelian` Lean files.
...
See rh-p5-bridge-14/CHAIN.md for all 19 repo HEADs at lock time.
```
