...
// Imports: Init Mathlib.Analysis.SpecificLimits.Normed Mathlib.Analysis.SpecialFunctions.Pow.Real Mathlib.Analysis.SpecialFunctions.Pow.Asymptotics Mathlib.Topology.Algebra.InfiniteSum.Order
#include <lean/lean.h>
